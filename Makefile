...
SOURCES+= ./mzapo_regs.h ./mzapo_parlcd.h ./mzapo_parlcd.c ./mzapo_phys.c ./mzapo_phys.h ./utils.c ./utils.h
CFILES= ./imgwrite.c ./main.c ./font_prop14x16.c ./font_rom8x16.c ./netcom.c ./messages.c ./utils.c
